...
This CV is automatically rendered from an R markdown file whenever there is a new commit to the repo. Check out the [source code](README.Rmd).
...
This list of publications is always up to date, because it is automatically generated through a direct call to Google Scholar. Check out the [source code](README.Rmd).
